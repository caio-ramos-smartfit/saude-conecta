  ...
  return (
    <div className="flex flex-col min-h-screen">
          ...
          <div className="container px-4 md:px-6 mx-auto">
            <div className="flex flex-col items-center justify-center space-y-4 text-center">
              <div className="space-y-2">
                ...
                <h2 className="text-3xl font-bold tracking-tighter md:text-4xl/tight">
                  Processo Simples, Melhor Acesso
                </h2>
                <p className="max-w-[900px] text-muted-foreground md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed">
            ...
            <div className="mx-auto grid max-w-5xl items-center gap-6 py-12 lg:grid-cols-2 lg:gap-12">
              <div className="flex flex-col justify-center space-y-4">
                <div className="space-y-2">
                  ...
                  <p className="text-muted-foreground">
                    As clinicas postam as vagas gratuitas e os detalhes pertinentes
                  </p>
                </div>
                <div className="space-y-2">
                  <div className="inline-flex h-8 w-8 items-center justify-center rounded-full bg-primary text-primary-foreground">
                  ...
                  <p className="text-muted-foreground">
                    O pacientes pode visualizar vagas disponíveis.
                  </p>
                </div>
                <div className="space-y-2">
                  <div className="inline-flex h-8 w-8 items-center justify-center rounded-full bg-primary text-primary-foreground">
      ...
      <footer className="border-t w-full">
        <div className="container flex flex-col gap-6 py-8 md:flex-row md:items-center md:justify-between md:py-12 mx-auto">
        ...
        <div className="border-t py-6 w-full">
          <div className="container flex flex-col items-center justify-center gap-4 md:flex-row md:justify-between mx-auto">
            <p className="text-center text-sm text-muted-foreground md:text-left">
              © {new Date().getFullYear()} SaúdeConecta. Todos os direitos reservados.
            </p>
          </div>
        </div>
      </footer>
